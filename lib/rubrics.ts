...
export const RUBRICS: Rubric[] = [
  ...
  },
  {
    ...
    note:
      "Delegations are read from your SPL token accounts (delegate field set, non-zero amount). Stake-account authorities are read from native stake accounts where staker or withdrawer differs from this wallet. Staleness is inferred against the 90-day activity peer set.",
  },
  {
    factor: "wealth",
